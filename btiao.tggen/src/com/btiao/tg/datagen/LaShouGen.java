...
public class LaShouGen extends WoWoGen {
	...
	protected boolean genTg() {
		...
		String type = ((Node)tgNode.selectNodes("data/display/subClass").get(0)).getText();
		...
		tgTmp.useEndTime = tmStr2Long(((Node)tgNode.selectNodes("data/display/merchantEndTime").get(0)).getText());
